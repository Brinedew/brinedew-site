...
Copying a genome is expensive to do accurately. A lineage that maintains proofreading polymerases, mismatch repair, and damage surveillance ([ATM](atm.md), [ATR](atr.md)) spends resources on fidelity that it could have spent on growth. The return on that spending is cumulative: every division made with an accurate copy preserves the value of the previous ones, the way interest accrues on principal. A lineage that cuts corners on fidelity banks divisions now and pays in mutations later.
...
- [OGG1](ogg1-o15527.md) — a base-excision repair enzyme
