...
So, according to Aubrey here, they used a method called Aspartic acid racemization (AAR) to estimate the age of the mouse at death. 
...
To give AI some credit back, for a researcher who knows how to formulate the right prompt, AI can plausibly assist with digging up something worth following up on. Sean Goedecke and many others have [called out](https://www.seangoedecke.com/llms-reward-expertise/) this "smart get smarter" knowledge multiplier dynamic of AI after trying to read Terence Tao's ChatGPT transcripts.
![[image-62.png]]
