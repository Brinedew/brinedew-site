...
length (aa): 766
locations: cell body; centriolar satellite; ciliary basal body; cilium; cytoplasm; cytosol; glutamatergic synapse; intracellular membrane-bounded organelle; mitochondrion; neuron projection; nucleus; plasma membrane; postsynapse; presynapse
mass: 84
membrane_depth: 1
pathways:
  - MAPK signaling
...
**Why it matters here.** Mutant BRAF (e.g., V600E) gives strong growth drive; targeted by specific inhibitors.

**Notes.** Pathway: MAPK cascade.