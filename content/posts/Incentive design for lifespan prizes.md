...
<changeDescription>
I'll expand sections 4-6 into a complete, detailed essay that matches the quality of your opening sections.

### [Incentive design for lifespan prizes.md](file:///d%3A/Coding/Website/content/posts/Incentive%20design%20for%20lifespan%20prizes.md)

Expanding sections 4-6 with full arguments, examples, and concrete mechanisms to match the depth of sections 1-3.
...
The Mprize taught us that winner-takes-all doesn't work for multi-year biological research. But what does? Let's design a prize structure that creates a sustainable ecosystem of longevity labs—one that pays out predictably, rewards real progress, and can't be easily gamed.
