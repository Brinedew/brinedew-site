...
[fill later in your own words: Weinstein reverse capacity / telomere framing — one paragraph in your voice]
...
1. "Cellular resilience / immortality / clock reset" marketing that ignores managed fragility should fail or backfire.
2. Single-gene suppression without systemic trade-off accounting is suspect (exception: developmentally restricted oncogenes that should stay off in adults).
3. Mid-life healthspan cosmetics can diverge from lifespan — demand lifespan data, not only frailty scores.
4. Genome stability is a budget spent on regen, size, or longevity — not all three. Claims of free regen need mutation-rate and longevity receipts.
