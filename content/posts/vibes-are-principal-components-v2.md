...
1. I want to i want to talk about something that took me an embarrassingly a long time to understand
2. If you spend some time lurking on the photography forums you will find Questions like. How do I replicate the moody vibe of this photo? And the comments section invariably. Will be dunking on the person who asked this question like, what do you mean? by ask questions normally? What exactly do you want to replicate? This is just a dark photo. Etc.
3. Just like a basketball player who is intuitively very good. At calculating the parabola for the true feelings, but not good at explaining the mathematical formula that draws this. Probably maybe we should pay more attention to the intuitive feeling than for the words. We used to describe it, so what does this feeling tell us what useful function does it perform?
