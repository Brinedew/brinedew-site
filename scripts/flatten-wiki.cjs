...
const migrationMap = {
  ...
  "wiki/theories/antagonistic-pleiotropy-theory.md": {
    ...
    tags: [
      ...
      "category/theory",
      "topic/aging",
      "theory/antagonistic-pleiotropy",
      "status/complete",
    ],
    aliases: [
      "wiki/theories/antagonistic-pleiotropy-theory",
      "theories/antagonistic-pleiotropy-theory",
    ],
  },
  "wiki/theories/defensive-degeneration-theory.md": {
    ...
    tags: [
      ...
      "category/theory",
      "topic/aging",
      "theory/defensive-degeneration",
      "status/stub",
    ],
    aliases: [
      "wiki/theories/defensive-degeneration-theory",
      "theories/defensive-degeneration-theory",
    ],
  },
  ...
  "wiki/theories/tumor-suppressor-theory-of-aging.md": {
    ...
    tags: [
      ...
      "topic/aging",
      "topic/cancer",
      "theory/tumor-suppressor",
      "status/stub",
    ],
    aliases: [
      "wiki/theories/tumor-suppressor-theory-of-aging",
      "theories/tumor-suppressor-theory-of-aging",
    ],
  },
  ...
  "wiki/organisms/cancer-lineages/ctvt.md": {
    ...
    tags: [
      "content/wiki",
      "category/organism",
      "organism/cancer-cell-line",
      "specific/ctvt",
      "topic/cancer",
      "status/stub",
    ],
    aliases: [
      "wiki/organisms/cancer-lineages/ctvt",
      "organisms/cancer-lineages/ctvt",
      "cancer-lineages/ctvt",
    ],
  },
  "wiki/organisms/cancer-lineages/dftd.md": {
    ...
    aliases: [
      "wiki/organisms/cancer-lineages/dftd",
      "organisms/cancer-lineages/dftd",
      "cancer-lineages/dftd",
    ],
  },
  "wiki/organisms/cancer-lineages/hela.md": {
    ...
    aliases: [
      "wiki/organisms/cancer-lineages/hela",
      "organisms/cancer-lineages/hela",
      "cancer-lineages/hela",
    ],
  },
  ...
  "wiki/proteins/oncogenes/oncogene-classification.md": {
    ...
    aliases: [
      "wiki/proteins/oncogenes/oncogene-classification",
      "proteins/oncogenes/oncogene-classification",
      "oncogenes/oncogene-classification",
    ],
  },
}
