...
- **Don't argue with the user about something they can verify in one click.** Example: when told the Boosty bot is on the server, *check* it instead of saying "I don't know." The user can verify; verify with them.
