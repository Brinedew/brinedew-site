      ...
      <article class="icono-card icono-card--brick icono-card--brick-static icono-gene-lead-card icono-card--variant-lab-label" style="--width:882;--height:1134;--icono-card-accent:#8a6f4d" data-icono-card-variant="lit-archival" data-icono-static-gene-shell="true">
        ...
        <div class="iconoplasm-tooltip-body icono-label-mobile-info-card">
          <div class="icono-label-sheet-body">
            ...
            <div class="icono-label-band-row"><div class="icono-label-row-label">field notes</div><div class="icono-label-band-grid"><div class="icono-label-band-cell icono-label-band-cell--category"><div class="icono-label-caption">category</div><div class="icono-label-band-primary"><div class="icono-label-category-grid" aria-hidden="true"><div class="icono-label-category-option icono-label-category-option--transmembrane"><span class="icono-label-option"><span class="icono-label-option-copy">TRANSMEMBRANE</span></span></div><div class="icono-label-category-option icono-label-category-option--soluble"><span class="icono-label-option"><span class="icono-label-option-copy">SOLUBLE</span></span></div></div></div></div><div class="icono-label-band-cell icono-label-band-cell--noted"><div class="icono-label-caption">first noted</div></div><div class="icono-label-band-cell icono-label-band-cell--mass"><div class="icono-label-caption">mass</div><div class="icono-label-band-primary"><div class="icono-label-mass-line"><span class="icono-label-mass-fill"></span><span class="icono-label-mass-unit-stack"><span class="icono-label-typed-value icono-label-typed-value--band icono-label-typed-value--crossed icono-label-typed-value--unit-kda">kDa</span><span class="icono-label-hand-note icono-label-hand-note--unit">kg</span></span></div></div></div></div></div>
            <div class="icono-label-style-row"><div class="icono-label-row-label">pfam clans</div><div class="icono-label-style-stack"></div></div>
            <div class="icono-label-alignment-row"><div class="icono-label-row-label">alignment</div><div class="icono-label-alignment-body"><div class="icono-label-selector-row icono-label-selector-row--alignment is-neither" aria-hidden="true"><span class="icono-label-option"><span class="icono-label-option-copy">ONCOGENE</span></span><span class="icono-label-option"><span class="icono-label-option-copy">TUMOR SUPPRESSOR</span></span><span class="icono-label-alignment-strike" aria-hidden="true"></span></div></div></div>
