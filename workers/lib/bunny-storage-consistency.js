...
// 2026-08-04 RHOC upload also proved that a documented success response can
// remain unreadable indefinitely; repeating the same immutable key and bytes is
// safe, while repeating Browser Rendering is wasteful and can change pixels.
export const BUNNY_READ_AFTER_WRITE_DELAYS_MS = Object.freeze([0, 1000, 2000, 4000, 8000])

export const BUNNY_IDEMPOTENT_PUT_ATTEMPTS = 3
