...
function buildRepresentationFromStoredSource(protein) {
  ...
  if (source === "swissmodel" && protein.swissmodel_url) {
    return {
      source: "swissmodel",
      structureId: protein.swissmodel_template
        ? String(protein.swissmodel_template)
        : protein.uniprot
          ? String(protein.uniprot)
          : "SWISS",
      coverage:
        typeof protein.swissmodel_coverage === "number" ? protein.swissmodel_coverage : null,
      swissModel: {
