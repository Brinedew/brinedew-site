...
export const ICONOPLASM_ROUTE_CONTRACTS = Object.freeze([
  ...
  iconoplasmApiContract({
    ...
    id: "caretaker_invitations",
    match: exact("/api/iconoplasm/caretaker/invitations"),
    methods: GET,
    auth: "authenticated-caretaker",
    budgetFamily: "caretaker_invitations_read",
  }),
  iconoplasmApiContract({
    apiHandler: "caretaker_notifications",
    id: "caretaker_invitations_read",
    match: exact("/api/iconoplasm/caretaker/invitations/read"),
    methods: POST,
    auth: "authenticated-caretaker",
    budgetFamily: "caretaker_invitations_write",
  }),
  iconoplasmApiContract({
    apiHandler: "caretaker_manifestations",
  ...
  adminApiContract(
    "caretaker_admin_offer",
    "/caretakers/offers",
    POST,
    "admin_caretaker_mutation",
    "caretaker_admin.mutate",
  ),
  iconoplasmApiContract({
