...
test("admin asset summary refresh writes public stats projection to KV", async () => {
  ...
  assert.equal(projected.generated_candidate_blot_count, 39548)
  assert.equal(projected.auditable_candidate_blot_count, 39179)
  assert.equal(projected.canonical_blot_count, 19090)
