...
test("factory selector activates accepted immutable recipes without exposing internal IDs", () => {
  ...
  assert.match(ICONOPLASM_ADMIN_HTML, /Recommended visions/)
  assert.match(ICONOPLASM_ADMIN_HTML, /id="factory-wiring-rows"/)
  assert.match(ICONOPLASM_ADMIN_RUNTIME, /data-factory-recommendation/)
  assert.match(ICONOPLASM_ADMIN_RUNTIME, /\/factory-recommendation/)
...
test("factory admin runs and displays a diagnostic matrix without leaving the panel", () => {
  ...
  assert.match(ICONOPLASM_ADMIN_SHELL, /lightbox-bootstrap\.js/)
  assert.match(ICONOPLASM_ADMIN_RUNTIME, /class="diagnostic-cell-image" data-icono-pswp/)
  assert.match(ICONOPLASM_ADMIN_RUNTIME, /data-icono-pswp-src=/)
  assert.match(ICONOPLASM_ADMIN_RUNTIME, /aria-label="Open full-size/)
