...
export const ICONOPLASM_FACTORY_CATALOG = Object.freeze({
  ...
  pipelines: Object.freeze([
    Object.freeze({ code: "A", label: "Aesthetic 1.1", model: "anima-aesthetic-v1.1.safetensors", steps: 38, cfg: 3.5, sampler: "dpmpp_2m_sde_gpu", width: 896, height: 1152, recommended_vision: 4, status: "accepted" }),
    Object.freeze({ code: "B", label: "Aesthetic 1.0b", model: "anima-aesthetic-v1.0b.safetensors", steps: 36, cfg: 3.2, sampler: "dpmpp_2m_sde_gpu", width: 896, height: 1152, recommended_vision: 4, status: "accepted" }),
    Object.freeze({ code: "C", label: "Preview 3", model: "anima-preview3-base.safetensors", steps: 30, cfg: 4, sampler: "er_sde", width: 896, height: 1152, recommended_vision: 7, status: "accepted" }),
    Object.freeze({ code: "D", label: "Base 1.0", model: "anima-base-v1.0.safetensors", steps: 40, cfg: 4.5, sampler: "dpmpp_2m_sde_gpu", width: 896, height: 1152, recommended_vision: 7, status: "accepted" }),
    Object.freeze({ code: "E", label: "Turbo 1.0", model: "anima-turbo-v1.0.safetensors", steps: 10, cfg: 1, sampler: "euler", width: 896, height: 1152, recommended_vision: 8, status: "accepted" }),
    Object.freeze({ code: "F", label: "Preview 3 · DPM++ 2M SDE", model: "anima-preview3-base.safetensors", steps: 30, cfg: 4, sampler: "dpmpp_2m_sde_gpu", width: 896, height: 1152, recommended_vision: 7, status: "accepted" }),
    Object.freeze({ code: "G", label: "Preview 3 · Euler a", model: "anima-preview3-base.safetensors", steps: 30, cfg: 4, sampler: "euler_ancestral", width: 896, height: 1152, recommended_vision: 7, status: "accepted" }),
    ...
    Object.freeze({ code: "L", label: "Turbo 1.0 · 1536×2048", model: "anima-turbo-v1.0.safetensors", steps: 10, cfg: 1, sampler: "euler", width: 1536, height: 2048, recommended_vision: 8, status: "accepted" }),
