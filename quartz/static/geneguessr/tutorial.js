;(function () {
  ...
  const STEP_CONTENT = [
    {
      ...
      body: [
        {
          img: 1,
          text: "This is the protein of the day. \n Can you figure out which gene made it?",
        },
        {
          img: 2,
          text: "You will see spoiler bars that cover valuable hints. \n Tap the spoiler bar to reveal a hint underneath.",
        },
        {
          img: 3,
          text: "Look up your favorite gene with the search bar. \n Submit it as your first guess.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      body: [
        {
          img: 7,
          text: "It costs 1 hint to remove a spoiler bar. \n You get +1 hint for each guess.",
        },
        {
          img: 8,
          text: "When the hint is too obvious, the bar stays locked. \n Just try unlocking another one.",
        },
        {
          img: 9,
          text: "You get to make 10 guesses before the game ends. \n Feel free to experiment!",
        },
      ],
    },
  ]
  ...
  function preloadAllIllustrations() {
    const slots = Object.keys(ILLUSTRATION_FILES)
      .map((k) => Number(k))
