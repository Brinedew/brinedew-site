import {
  ...
  mountSidebarStack,
  wireSharedUserPanel,
} from "../shared/sidebar-shell.js?v=20260309g"
  ...
  function injectSidebarStats() {
    ...
    const stack = mountSidebarStack({
      ...
      panels: [
        ...
        {
          id: "pg-sidebar-stats-panel",
          className: "brd-sidebar-panel--geneguessr",
          markup: `
      <div class="brd-sidebar-section">
        <div class="brd-sidebar-panel-title">Geneguessr</div>
      </div>
      <div id="pg-sidebar-stats" class="pg-sidebar-stats">
