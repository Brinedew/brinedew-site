...
;(function (global) {
  ...
  function renderMobileArchivalPhysicalSleeveHtml(portraitHtml, infoHtml, options) {
    ...
    return (
      ...
      '<div class="icono-label-mobile-pocket-material" data-icono-material-system="baked-paper-atlas" aria-hidden="true">' +
      '<img class="icono-pocket-layer icono-pocket-card-contact-shadow" alt="" src="/static/iconoplasm/materials/mobile-pocket/pocket-card-contact-shadow.png">' +
      '<img class="icono-pocket-layer icono-pocket-lip-shadow" alt="" src="/static/iconoplasm/materials/mobile-pocket/pocket-lip-shadow.png">' +
      '<img class="icono-pocket-layer icono-pocket-albedo" alt="" src="/static/iconoplasm/materials/mobile-pocket/pocket-front-albedo.webp">' +
      '<img class="icono-pocket-layer icono-pocket-ao" alt="" src="/static/iconoplasm/materials/mobile-pocket/pocket-front-ao.webp">' +
      '<img class="icono-pocket-layer icono-pocket-edgewear" alt="" src="/static/iconoplasm/materials/mobile-pocket/pocket-front-edgewear.png">' +
      '<img class="icono-pocket-layer icono-pocket-stains" alt="" src="/static/iconoplasm/materials/mobile-pocket/pocket-front-stains.webp">' +
      '<img class="icono-pocket-layer icono-pocket-hole-shadow" alt="" src="/static/iconoplasm/materials/mobile-pocket/thumb-hole-inner-shadow.png">' +
      "</div>" +
