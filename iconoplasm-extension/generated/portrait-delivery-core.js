...
"use strict";
var IconoplasmPortraitDelivery = (() => {
  ...
  var portrait_delivery_core_exports = {};
  __export(portrait_delivery_core_exports, {
    DEFAULT_PORTRAIT_DELIVERY_POLICY: () => DEFAULT_PORTRAIT_DELIVERY_POLICY,
    createPortraitDeliverySession: () => createPortraitDeliverySession,
    normalizePortraitDeliveryPolicy: () => normalizePortraitDeliveryPolicy,
    normalizePortraitDeliveryState: () => normalizePortraitDeliveryState,
    portraitPath: () => portraitPath,
    portraitSourceFromUrl: () => portraitSourceFromUrl,
    portraitUrlForSource: () => portraitUrlForSource,
    transitionPortraitDelivery: () => transitionPortraitDelivery
  });
  ...
  function createPortraitDeliverySession(options = {}) {
    ...
    function plan(rawUrl) {
      ...
      const canFallback = !state.failed.includes(fallbackSource) && (fallbackSource !== "accelerator" || policy.accelerator.enabled);
      return {
        path,
        primarySource,
  ...
  return __toCommonJS(portrait_delivery_core_exports);
})();
