...
// ../../../node_modules/.pnpm/@quartz-community+utils@htt_0cfbeb8e17e882336c3b6fb8d860c4b0/node_modules/@quartz-community/utils/dist/sort.js
...
// ../../../node_modules/.pnpm/@quartz-community+utils@htt_0cfbeb8e17e882336c3b6fb8d860c4b0/node_modules/@quartz-community/utils/dist/jsx.js
import { jsxs as jsxs2, jsx as jsx2, Fragment } from "preact/jsx-runtime";
...
function humanizeTag(tag, displayNames = defaultTagDisplayNames) {
...
var TagContent_default = ((opts) => {
  ...
  const TagContent = (props) => {
    ...
    if (tag === "/") {
      ...
      return /* @__PURE__ */ jsxs3("div", { class: "popover-hint", children: [
        /* @__PURE__ */ jsx3("article", { class: classes, children: /* @__PURE__ */ jsx3("div", { class: "markdown-preview-view markdown-rendered", children: /* @__PURE__ */ jsx3("p", { children: content }) }) }),
        /* @__PURE__ */ jsx3("p", { children: i18n(locale).pages.tagContent.totalTags({ count: tags.length }) }),
        /* @__PURE__ */ jsx3("div", { children: tags.map((t) => {
          ...
          return /* @__PURE__ */ jsxs3("div", { children: [
            /* @__PURE__ */ jsx3("h2", { children: /* @__PURE__ */ jsx3("a", { class: "internal tag-link", href, children: humanizeTag(t) }) }),
            tagDesc && /* @__PURE__ */ jsx3("p", { children: tagDesc }),
            /* @__PURE__ */ jsxs3("div", { class: "page-listing", children: [
              /* @__PURE__ */ jsxs3("p", { children: [
                i18n(locale).pages.tagContent.itemsUnderTag({ count: pages.length }),
                pages.length > options.numPages && /* @__PURE__ */ jsxs3(Fragment2, { children: [
                  " ",
                  /* @__PURE__ */ jsx3("span", { children: i18n(locale).pages.tagContent.showingFirst({
      ...
      return /* @__PURE__ */ jsxs3("div", { class: "popover-hint", children: [
        /* @__PURE__ */ jsx3("article", { class: classes, children: /* @__PURE__ */ jsx3("div", { class: "markdown-preview-view markdown-rendered", children: content }) }),
        /* @__PURE__ */ jsxs3("div", { class: "page-listing", children: [
          /* @__PURE__ */ jsx3("p", { children: i18n(locale).pages.tagContent.itemsUnderTag({ count: pages.length }) }),
          /* @__PURE__ */ jsx3("div", { children: pageListContent })
        ] })
      ] });
    }
  };
...
function humanizeTag2(tag, displayNames) {
  if (displayNames[tag]) return displayNames[tag];
  const leaf = tag.includes("/") ? tag.slice(tag.lastIndexOf("/") + 1) : tag;
  if (!leaf) return tag;
  return leaf.charAt(0).toUpperCase() + leaf.slice(1);
...
var TagPage = (opts) => ({
  ...
  generate({ content, cfg }) {
    ...
    const locale = cfg?.locale ?? "en-US";
    const displayNames = { ...defaultTagDisplayNames2, ...opts?.displayNames ?? {} };
    const tags = new Set(
    ...
    for (const tag of tags) {
      ...
      const label = humanizeTag2(tag, displayNames);
      const title = tag === "index" ? i18n(locale).pages.tagContent.tagIndex : opts?.prefixTags ? `${i18n(locale).pages.tagContent.tag}: ${label}` : label;
      virtualPages.push({
        slug: slug2,
        title,
        data: {}
